...
process buildCode {
  ...
  input:
    ...
    val codeRevision from 'c79682748b528a73cd3d14ec7c9a76fa83603e2c'
...
process runBlang {
  ...
  input:
    each method from '--engine iscm.ISCM --engine.scm.nThreads Single --engine.scm.usePosteriorSamplingScan true --engine.initialNumberOfSMCIterations 2 --engine.nRounds 15 --engine.scm.nParticles 20',
